...
public class Lab2 extends LabSetup {
    public Lab2(String s) {
        super(s);
    }

    MyLinkedList<Integer> list = new MyLinkedList<>();
    Button btInsert, btDelete, btFind, btReverse;
    TextField tfData;
    Label lblOutput;
    ...
    public void Events() {
        ...
        btFind.setOnAction(e->
                lblOutput.setText("Result is "+list.find(Integer.parseInt(tfData.getText()))));
    ...
    public void ShapeGrid() {
        ...
        grid.add(btFind = new Button("Find"), 1, 2);
